                    ...
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8 mt-4">
                        ...
                        <FormField control={form.control} name="credentialId" render={({ field }) => (
                            <FormItem>
                                ...
                                <Select disabled={isLoadingCredentials || !credentials?.length} onValueChange={field.onChange} defaultValue={field.value}>
                                    <FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea className="min-h-[120px] font-mono text-sm" placeholder="You are a helpful assistent" {...field} />
                                    </FormControl>
                                    <FormDescription>Sets the behavior of the assistent. Use {"{{variables}}"} for simple values or {"{{json variable}}"} to stringify objects</FormDescription>
